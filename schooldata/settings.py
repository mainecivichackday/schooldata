"""
Django settings for our schooldata project.
...
class Common(Configuration):
    ...
    sys.path.insert(0, os.path.join(BASE_DIR, 'schooldata/apps'))
    ...
    TEMPLATE_DIRS = (os.path.join(BASE_DIR, "schooldata/templates"),)
    ...
    STATICFILES_DIRS = (
        os.path.join(BASE_DIR, "schooldata/static"),
    )
